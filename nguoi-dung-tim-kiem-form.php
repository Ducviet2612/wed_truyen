...
<body>
        ...
        $username = isset($_SESSION['email']) ? $_SESSION['email'] : null;
            ...
            echo '<div class="story-item">
                    <img src="' . htmlspecialchars($image_url) . '" alt="Truyện 1" class="story-image">
                        ...
                        <div class="view-more">
                          <a href="xu_ly_mua_hang_1.php?id='. $row['id'] .'&the_loai='. urlencode($row['the_loai']) .'&username='. urlencode($username).'" class="btn-mua">Mua ngay</a>
                    </div>
                    </div>';
    ...
    <div class="back-to-home">
        <a href="/webtruyen/trang-chu.php?page=trangchu">Quay lại trang chủ</a>
    </div>
